...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- Hemant -->
            ...
            <?php if(Auth::user()->type != 'super admin'): ?>
                <div class="col-md-12">
                    <div class="form-group">
                        <?php echo e(Form::label('manager', __('Managers'),['class'=>'form-label'])); ?>

                        <?php echo e(Form::select('manager',$user,null, ['class' => 'form-control', 'id' => 'manager_id', 'data-toggle' => 'select'])); ?>
...
<?php /**PATH C:\xampp\htdocs\koristu\resources\views/users/create.blade.php ENDPATH**/ ?>