...
<?php $__env->startSection('page-action'); ?>
    <div>
        ...
        <?php if((module_is_active('ProductService') && module_is_active('Account')) || module_is_active('Taskly')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoice manage')): ?>
                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            <thead>
                                <tr>
                                    ...
                                    <?php if(Gate::check('invoice edit') ||
                            ...
                            <tbody>
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="Id">
                                            <?php if(Gate::check('invoice show')): ?>
                                            ...
                                            <td class="Action">
                                                <span>
                                                    ...
                                                    <?php if(module_is_active('EInvoice')): ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('download invoice')): ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('invoice duplicate')): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koristu\resources\views/invoice/index.blade.php ENDPATH**/ ?>