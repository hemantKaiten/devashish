...
<?php echo e(Form::open(array('url' => 'leads','enctype'=>'multipart/form-data'))); ?>
    ...
    <div class="modal-body">
        ...
        <?php if(module_is_active('CustomField') && !$customFields->isEmpty()): ?>
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#tab-1" role="tab" aria-controls="pills-home" aria-selected="true"><?php echo e(__('Lead Detail')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#tab-2" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo e(__('Custom Fields')); ?></a>
                </li>
            </ul>
        <?php endif; ?>
...
<!-- CODE FOR COUNTRY DROPDOWNS ADDED BY HEMANT -->
                    ...
                    <div class="col-6 form-group">
                    <?php echo e(Form::label('name', __('Country'),['class'=>'col-form-label'])); ?>

                        <?php echo e(Form::select('name', $country,null, array('class' => 'form-control country','id' => 'country_id','required'=>'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\koristu\Modules/Lead\Resources/views/leads/create.blade.php ENDPATH**/ ?>